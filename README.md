...
| [platform/android/](platform/android/) | Contains the Android platform project and instructions on how to build this project for Android and run it.                         | [![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_android.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_android.yml) | [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying) |
| [platform/ios/](platform/ios/)         | Contains the iOS platform project and instructions on how to build this project for iOS and run it.                                 | [![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_ios.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_ios.yml)         | [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying) |
| [platform/linux/](platform/linux/)     | Contains the Linux platform project and instructions on how to build this project for Linux and run it.                             | [![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_linux.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_linux.yml)     | [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying) |
| [platform/macos/](platform/macos/)     | Contains the macOS platform project and instructions on how to build this project for macOS and run it.                             | [![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_macos.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_macos.yml)     | [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying) |
| [platform/windows/](platform/windows/) | Contains the Windows platform project and instructions on how to build this project for Windows and run it.                         | [![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_windows.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_windows.yml) | [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying) |
| [shared/](shared/)                     | Contains the **shared** code between **all** projects.                                                                              | [![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/shared.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/shared.yml)                     | [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying) |
...
[![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_android.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_android.yml)
...
[![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_linux.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_linux.yml)
[![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_macos.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/platform_macos.yml)
...
[![Rust](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/shared.yml/badge.svg)](https://github.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/actions/workflows/shared.yml)
...
[![CircleCI](https://circleci.com/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/tree/main.svg?style=svg)](https://circleci.com/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/tree/main)

> Note that a failure here can also mean we run out of credits. Happens too often unfortunately!

### CI Platform: Travis

[![Build Status](https://app.travis-ci.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying.svg?branch=main)](https://app.travis-ci.com/rust-multiplatform/Compute-Engine-Example-Buffer-Copying)
...
[![pipeline status](https://gitlab.com/rust-multiplatform/compute-engine-example-buffer-copying/badges/main/pipeline.svg)](https://gitlab.com/rust-multiplatform/compute-engine-example-buffer-copying/-/commits/main)

### CI Platform: BitBucket Pipeline

Unfortunately, BitBucket Pipelines don't have status badges.

The pipelines are available at: [BitBucket Mirror](https://bitbucket.org/rust-multiplatform/compute-engine-example-buffer-copying/)
...
[![Build status](https://ci.appveyor.com/api/projects/status/nsffumoc868yqsrj/branch/main?svg=true)](https://ci.appveyor.com/project/Sakul6499/compute-engine-example-buffer-copying/branch/main)
...
[![Build Status](https://jenkins.sakul-flee.de/buildStatus/icon?job=github_rust_multiplatform%2FCompute-Engine-Example-Buffer-Copying%2Fmain)](https://jenkins.sakul-flee.de/job/github_rust_multiplatform/job/Compute-Engine-Example-Buffer-Copying/job/main/)
...
Test-to-Code coverage status: [![codecov](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graph/badge.svg?token=XpGvuQVirP)](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying)

Below are several charts showing/highlighting the distribution of **all platforms**.

### Sunburst

![Sunburst](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graphs/sunburst.svg?token=XpGvuQVirP)

### Grid

![Grid](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graphs/tree.svg?token=XpGvuQVirP)

### Icicle

![Icicle](https://codecov.io/gh/rust-multiplatform/Compute-Engine-Example-Buffer-Copying/branch/main/graphs/icicle.svg?token=XpGvuQVirP)
